...
旧v4.4.0が実際に検出した `pitch=129 / H=2160 = 0.0597` のような周期は、v4.4.5の `pitch/H=0.070～0.095` 条件では9行Gridとして採用しない。
...
## v4.4.5 internal validation change
